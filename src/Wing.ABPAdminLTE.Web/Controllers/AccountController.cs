...
using Wing.ABPAdminLTE.Web.Models.Account;
using Wing.ABPAdminLTE.Web.Views.Shared.Components.TenantChange;
...
namespace Wing.ABPAdminLTE.Web.Mvc.Controllers
{
    public class AccountController : ABPAdminLTEControllerBase
    {
        ...
        public async Task<IActionResult> TenantChangeModal()
        {
