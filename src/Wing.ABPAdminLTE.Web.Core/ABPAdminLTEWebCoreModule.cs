...
namespace Wing.ABPAdminLTE
{
    ...
    public class ABPAdminLTEWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ABPAdminLTEWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            Configuration.DefaultNameOrConnectionString = _appConfiguration.GetConnectionString(
                ABPAdminLTEConsts.ConnectionStringName
            );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ABPAdminLTEWebCoreModule).GetAssembly());
        }
    }
}
